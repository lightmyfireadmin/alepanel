...
- **Core Web Vitals** : optimisation images (next/image), prefetch critique, lazy loading, respect de `prefers-reduced-motion` et bascule vers transitions CSS/animations désactivées sur mobile low-end (viser INP < 200 ms, avec marge de confort; FPS > 50).
