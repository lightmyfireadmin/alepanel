...
export function DealFilter_3({
  ...
  const updateFilter = (key: string, value: string | undefined) => {
    ...
    startTransition(() => {
      // Pushing to /transactions_3 instead of /operations
      router.push(`/transactions_3?${params.toString()}`, { scroll: false });
    });
  };

  const clearFilters = () => {
    startTransition(() => {
      router.push("/transactions_3", { scroll: false });
    });
  };
