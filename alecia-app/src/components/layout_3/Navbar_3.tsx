...
export function Navbar_3() {
  ...
  // Navigation items for V3
  const navigationItems = [
    { href: "/expertises_3", label: t("expertises"), hasSubmenu: true },
    // Removed "Secteurs" to simplify as per V3 requirements
    { href: "/transactions_3", label: "Transactions" }, // Hardcoded label as translation key might differ
    { href: "/equipe_3", label: t("team") },
    { href: "/actualites_3", label: t("news") },
    { href: "/carrieres_3", label: t("careers") },
  ];

  const expertiseSubmenu = [
    { href: "/expertises_3#cession", label: t("cession") },
    { href: "/expertises_3#levee-de-fonds", label: t("fundraising") },
    { href: "/expertises_3#acquisition", label: t("acquisition") },
  ];
    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass" role="banner">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Navigation principale">
        <div className="flex items-center justify-between h-16 md:h-20">
          {/* Logo */}
          <Link href="/page_3" className="flex items-center focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] rounded-lg" aria-label="alecia - Accueil">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button asChild className="btn-gold rounded-lg focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]">
              <Link href="/contact_3">{t("contact")}</Link>
            </Button>
          </div>
              ...
              <div className="flex flex-col h-full py-6">
                ...
                <div className="space-y-4 pt-6 border-t border-[var(--border)]">
                  ...
                  <Button asChild className="btn-gold w-full rounded-lg">
                    <Link href="/contact_3" onClick={() => setIsOpen(false)}>
                      {t("contact")}
                    </Link>
                  </Button>
                </div>
