...
const footerLinks = {
  services: [
    { href: "/expertises_3#cession", label: "Cession & transmission" },
    { href: "/expertises_3#levee-de-fonds", label: "Levée de fonds" },
    { href: "/expertises_3#acquisition", label: "Acquisition" },
  ],
  company: [
    { href: "/equipe_3", label: "Notre équipe" },
    { href: "/transactions_3", label: "Nos opérations" },
    { href: "/actualites_3", label: "Actualités" },
    { href: "/carrieres_3", label: "Carrières" },
    { href: "/acces-prive_3", label: "Accès privé" },
  ],
  offices: [
