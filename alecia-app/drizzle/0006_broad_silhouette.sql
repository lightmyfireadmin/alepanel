...
CREATE INDEX "kanban_columns_board_id_idx" ON "kanban_columns" USING btree ("board_id");--> statement-breakpoint
CREATE INDEX "projects_column_id_idx" ON "projects" USING btree ("column_id");