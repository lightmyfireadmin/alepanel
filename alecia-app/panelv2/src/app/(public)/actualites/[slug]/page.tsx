...
import { getBlogPostBySlug } from "@/lib/actions/convex-marketing";
...
// Helper to normalize cover image
function normalizeCoverImage(coverImage?: string | null): string {
  if (!coverImage) return "/images/placeholder-blog.jpg";
